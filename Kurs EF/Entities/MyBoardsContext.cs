using Kurs_EF.Entities.Configurations;
...
//Pierwszy sposób konfiguracji DbContekstu (później przeniesiono do klas konfiguracyjnych):
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            //new AdressConfiguration().Configure(modelBuilder.Entity<Adress>());   //<-Pierwszy sposób dla pojedyńczej konfiguracji
            modelBuilder.ApplyConfigurationsFromAssembly(this.GetType().Assembly);  //<-Drugi sposób dla całości (skanuje własne foldery w poszukiwaniu konfiguracji)
            ...
            ////Pierwszy sposób konfiguracji DbContekstu (później przeniesionydo klasy konfiguracyjnej):
            ...
            //modelBuilder.Entity<Adress>()       //drugi sposób na konfigurację połączenia encji KEYLESS
